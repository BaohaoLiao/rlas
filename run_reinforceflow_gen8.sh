...
HOME=/mnt/nushare2/data/baliao/dynamic_filter

# very important! please modify the max_position_embeddings in config.json to 32768 after downloading from huggingface

MODEL_PATH="/mnt/nushare2/data/baliao/PLLMs/meta-llama/Llama-3.2-3B-Instruct" # 确保这里的模型大小 (7B) 和实验名称一致
...
exp_name='DAPO-Llama-3.2-3B-Instruct-fix-gen8-continuous' # 更新了实验名称以作区分
...
CKPTS_DIR="/mnt/nushare2/data/baliao/dynamic_filter/00_start/${project_name}/${exp_name}"
TRAIN_FILE="${HOME}/data/openr1/train.parquet"
